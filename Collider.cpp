...
void Collider::SetValues(float _x1,float _y1,float _z1, float _x2,float _y2,float _z2  )
{
    ...
    vertices.push_back(glm::vec4(x1,y1,z1));
    vertices.push_back(glm::vec4(x1,y1,z2));
    vertices.push_back(glm::vec4(x1,y2,z1));
    vertices.push_back(glm::vec4(x1,y2,z2));
    vertices.push_back(glm::vec4(x2,y1,z1));
    vertices.push_back(glm::vec4(x2,y1,z2));
    vertices.push_back(glm::vec4(x2,y2,z1));
    vertices.push_back(glm::vec4(x2,y2,z2));
